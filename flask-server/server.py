...
with open(r'C:\Users\thejan\calories_burn_prediction\flask-server\pipeline.pkl', 'rb') as f:
...
def predict():
    ...
    return jsonify(result[0].tolist())  # Convert result to a list for jsonify
